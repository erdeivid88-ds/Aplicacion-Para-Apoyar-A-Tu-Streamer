...
La versión actual se obtiene de `package.json` y se muestra desde `app.getVersion()`.

## Una experiencia pensada para todo el mundo

La aplicación se organiza en Inicio, Streamers, Plataformas, Automatizaciones, Navegador, Actividad y Ajustes. Incluye navegación adaptable, temas claro/oscuro/sistema, onboarding, estados vacíos útiles, ayuda contextual y guardado automático con validación y debounce.
